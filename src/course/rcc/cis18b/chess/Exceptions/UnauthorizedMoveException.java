package course.rcc.cis18b.chess.Exceptions;
...
public class UnauthorizedMoveException extends Exception {
     ...
     * @since 1.7
     */
    public UnauthorizedMoveException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
